...
const { getStudentDetails,getStudentName, getTotalCredits,getCertificatesCount ,coursesRegistered, getCalendarDetails, getNearestExamDetails, getCurrentCGPA, getAttendenceDays } = require('../controllers/studentController');
...
router.get('/name',authenticate,getStudentName);
